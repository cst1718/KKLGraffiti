package com.kkl.graffiti.edit.view;
...
public class SolidView extends android.support.v7.widget.AppCompatImageView {
    ...
    public void setBmpPath(String picPath, Activity activity) {
        Bitmap bitmapFromPath = ImageUtils.createBitmapFromPath(picPath, activity);
        setImageBitmap(bitmapFromPath);
        mBitmap = Bitmap.createBitmap(bitmapFromPath.getWidth(), bitmapFromPath.getHeight(), bitmapFromPath.getConfig());
