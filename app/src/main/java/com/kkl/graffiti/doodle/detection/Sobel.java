...
public class Sobel extends Detection {
    ...
    public Sobel(IDetectionResult callback) {
        super(callback);
    ...
    public void detection(Bitmap originalBitmap) {
        ...
        //将原图灰度化
        this.temp = ImageUtils.bitmap2Gray(this.originalBitmap);
        //图片的宽高
        int w = temp.getWidth();
