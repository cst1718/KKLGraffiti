package com.kkl.graffiti.doodle.touchUtils;
 ...
 *
 * https://github.com/1993hzw/Androids 1.2.3版本
 */
public class TouchGestureDetector {
     ...
     * 识别手势的回调接口
     */
    public static interface IOnTouchGestureListener
            extends GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, ScaleGestureDetectorApi27.OnScaleGestureListener {
        /**
